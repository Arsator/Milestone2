...
class ProdEcsConstructStack(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, **kwargs) -> None:
        ...
        ecs_patterns.ApplicationLoadBalancedFargateService(self, "Prod-Fargate-Service", cluster = cluster, desired_count = 2, cpu = 512, memory_limit_mib = 2048, task_image_options = ecs_patterns.ApplicationLoadBalancedTaskImageOptions(image = ecs.ContainerImage.from_registry("public.ecr.aws/t2u6r1h4/my-app1:latest")), public_load_balancer = True)
